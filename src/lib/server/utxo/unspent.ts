export const utxos = {
	...
	'9euvZDx78vhK5k1wBXsNvVFGc5cnoSasnXCzANpaawQveDCHLbU': [
		...
		{
			boxId: '3c2302b807c9755e66ce9f73b70d0ec5aa5965872d20f62702abf0870b666a4a',
			transactionId:
				'f284d4ebde8da5fcd5b60107a6474e5948d1dc8085c549a57ac4b14db9c03b82',
			blockId:
	...
	JixnxAz48B1XvS9qoad8H4amt9JcQQPQPE4uURGUWNWnN1D: [
		{
			boxId: 'bbd4c5a53495fbd071d691a261c33166dcb2af2a2f6819bfb890103cc1e881ea',
			transactionId:
				'3289d65f568a562558bf24fc5fd36ca67686dfc39cbe85dacb4fea2f074e9841',
			blockId:
			...
			ergoTree:
				'1000d801d601e4c6a705089591a3e4c6a704047201ea027201e4c6a70608',
			ergoTreeConstants: '',
			ergoTreeScript:
				'{\n  val prop1 = SELF.R5[SigmaProp].get\n  if (HEIGHT > SELF.R4[Int].get) { prop1 } else { prop1 && SELF.R6[SigmaProp].get }\n}',
			address: 'JixnxAz48B1XvS9qoad8H4amt9JcQQPQPE4uURGUWNWnN1D',
			assets: [],
			additionalRegisters: {
				R4: '0492b19901',
				R5: '08cd0233e9a9935c8bbb8ae09b2c944c1d060492a8832252665e043b0732bdf593bf2c',
				R6: '08cd025d163103d491a5193c7b18182442877ce8fcf3ffb9ae9c295d9c98a16dcb0551'
			},
			spentTransactionId: null,
			mainChain: true
		},
		{
			boxId: '5d278960fc6042e87e5dc69ba7211a98b249f89045fde04bea5330cc3ef9c7ac',
			transactionId:
				'4843e14a5bc37b1032f6ace58c03f0a7db65e76ae7594f4d4f8d97c318af44eb',
			blockId:
	...
	'':
		[
			{
				boxId: '430ce6ba1f0d4fd34e76386c10f9754e67c0a5db558baea3cd1c82dd25267032',
				transactionId:
					'f313a09270465b65c48e8446f56f6884921feab6fce1237c114fbb853f424db4',
				blockId:
					'00af65da4b5dfc66c1d700103f65503c55bd72c2ffbbac1ef1a6caf56e37fbb5',
			...
			{
				boxId: '8e2ad604cf9b49ce98effd403dcae628c207f30966dae6dd354be3d7e3f188d4',
				transactionId:
					'107e7532a6d1889c7ca78654fb0131d9b8628633059743ac738615c983fe53b2',
				blockId:
			...
			{
				boxId: '0ec3dd2a578da4e750b23e3aeae5a2aab90092d900aa8bd92c8b51a30a9b79e9',
				transactionId:
					'8362c64274ee55ec498e5ca4c894366eb7ae484feb094c142751a18b4eeb36d7',
				blockId:
			...
			},
			{
				...
				transactionId:
					'fd323564bacbe705e2505738e9c3cd26784ce06c4f0b403f4bb0f2197c4311f6',
				blockId:
			...
			{
				boxId: 'a340b2d618ddf2a6d62ed0f68040be004c701eaf25836a129a5c6b1c19d5ada4',
				transactionId:
					'74443d12b8378b7a532ad232e00034760992d6cab886bff87f1aa4d05b2ee6cb',
				blockId:
